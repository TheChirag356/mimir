<script lang="ts">
	...
	const dockerCommand = 'docker run -d -p 13378:8080 -v /path/to/audiobooks:/audiobooks mimir';
	...
	<section class="mx-auto max-w-6xl px-6 pt-32 pb-24">
		<div class="mx-auto max-w-4xl text-center">
			...
			<div class="mt-10 flex flex-col justify-center gap-3 sm:flex-row">
				...
				>
					Explore Live Demo <IconChevronRight class="ml-1 h-4 w-4" />
				</Button>
			</div>
		...
		<div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
			...
			>
				<div class="flex items-start gap-4">
					<IconDeviceMobile class="h-5 w-5 text-muted-foreground mt-0.5" />
					<div>
				...
				>
					Join TestFlight <IconChevronRight class="ml-0.5 h-3.5 w-3.5" />
				</a>
			</div>
			...
			>
				...
				<a
					...
					class="mt-6 text-[13px] font-medium text-primary flex items-center hover:underline"
				>
					Get on Google Play <IconChevronRight class="ml-0.5 h-3.5 w-3.5" />
				</a>
			</div>
			...
			>
				<div class="flex items-start gap-4">
					<IconDeviceDesktop class="h-5 w-5 text-muted-foreground mt-0.5" />
					<div>
				...
				<a
					...
					class="mt-6 text-[13px] font-medium text-primary flex items-center hover:underline"
				>
					Download Binaries <IconChevronRight class="ml-0.5 h-3.5 w-3.5" />
				</a>
			</div>
		</div>
	</section>
